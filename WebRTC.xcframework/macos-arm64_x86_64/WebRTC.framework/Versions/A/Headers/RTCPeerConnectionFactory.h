...
+ (void)setNTLMMessage1Callback:(nonnull NSString* (^)() )mesage1Block 
                  message3Block:(nonnull NSString* (^)( NSString* base64Message2))message3Block;

+ (void)resetProxy;

+ (void)setProxyHost:(NSString *)host 
                port:(int)port
               agent:(NSString *)userAgent;
